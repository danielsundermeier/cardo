<template>
    <div>
        ...
        <table class="table table-hover table-striped bg-white table-fixed" v-else-if="items.length">
            <thead>
                <tr>
                    <th width="100%">Bezeichnung</th>
                    <th class="text-right" width="110">Aktion</th>
                </tr>
            </thead>
            <tbody>
...
<script>
    import create from "../userfileable/create.vue";
    ...
    export default {
        ...
        data () {
            return {
                ...
                name: '',
                errors: {},
                action: this.uri + '/' + this.model.id + '/userfiles',
            };
        },
        ...
        methods: {
            ...
            fetch() {
                ...
                axios.get(component.uri + '/' + component.model.id + '/userfiles?searchtext=' + component.searchtext)
