        ...
        <div class="row">
            <div class="col d-flex align-items-start mb-1 mb-sm-0">
                <div class="form-group mb-0 mr-1">
                    <div>
                        <input type="text" class="form-control" :class="'at_formatted' in errors ? 'is-invalid' : ''" v-model="form.at_formatted" placeholder="" @keydown.enter="create">
    ...
    export default {
        ...
        data () {
            return {
                ...
                form: {
                    at_formatted: (new Date).toLocaleDateString('de-DE', {
                        month: '2-digit',
                        day: '2-digit',
                        year: 'numeric',
                    }),
