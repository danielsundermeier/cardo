...
class Food extends Model
{
    ...
    const ROUTE_NAME = 'diet.meals.foods';
    ...
    {
        return $this->belongsTo(\App\Models\Diet\Foods\Food::class, 'diet_food_id');
    }

    public function meal() : BelongsTo
    {
        return $this->belongsTo(\App\Models\Diet\Meals\Meal::class, 'diet_meal_id');
    }

    public function getRouteParameterAttribute() : array
    {
        return [
            'meal' => $this->diet_meal_id,
            'food' => $this->id,
        ];
    }
