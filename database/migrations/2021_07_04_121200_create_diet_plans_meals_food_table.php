...
class CreateDietPlansMealsFoodTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('diet_plans_meals_food', function (Blueprint $table) {
            $table->id();
            $table->foreignId('partner_id');
            $table->foreignId('diet_plans_meal_id');
            ...
            $table->foreign('diet_plans_meal_id')->references('id')->on('diet_plans_meals');
    ...
    {
        Schema::dropIfExists('diet_plans_meals_food');
    }
}
